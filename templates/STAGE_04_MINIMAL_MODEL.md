...
### Canonical-form / known-class screening

Before treating an application-specific result as a new theoretical object:

- write the solved model in application-neutral mathematical form, including strategy-set geometry, payoff/function class, interaction matrix/operator, coupling constraints, and equilibrium concept;
- strip names such as industries, regions, platforms, standards, firms, or policy instruments and test whether the object is recognizable as a standard class (for example LQ, network, aggregative, potential, super/submodular, contest/resource-allocation, simplex-constrained, assignment/transportation-polytope, or another canonical class);
- attempt elementary equivalence-preserving transformations where relevant: affine recentering, normalization, variable elimination, matrix form, KKT/complementarity form, potential representation, or polytope/extreme-point representation;
- record a **parent-class candidate list** and identify which headline propositions may be immediate specializations or corollaries of known general results;
- do not claim novelty from this screen. Pass the canonical representation and parent-class list unchanged to Stage 6 for literature-backed theorem absorption testing.
...
14. Canonical mathematical representation and parent-class candidate list
15. Preliminary theorem-certificate register
16. Consumer surplus and welfare, where applicable
17. Private vs social decision, where applicable
18. Limiting cases
19. Nested-benchmark recovery and comparison, where applicable
20. Full-model-only result table, where applicable
21. Numerical counterexample audit, where applicable
22. Permanent regression tests generated by counterexamples, where applicable
23. Artefact audit
24. Exact diagnosed blocker, if any
25. Canonical stage verdict
26. Routing/status output and next-stage contract
